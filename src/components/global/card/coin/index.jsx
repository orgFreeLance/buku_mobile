...
export default function CardCoin({ coinsNumber, price, currency, id: coin }) {
  ...
  return (
    <View style={styles.card}>
          ...
          <Loader loading={loading}>
            ...
            >
              <View style={styles.modal}>
                ...
                >
                  Félicitation pour votre achat de(s){" "}
                  <Text style={{ fontWeight: "bold" }}>{coinsNumber}</Text>{" "}
                  piece(s) !
                </Text>
              </View>
            </View>
      ...
      <ModalContainer closeModal={closeModalError} modal={modalError}>
        <>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <ImageViewer selectedImage={errorBg} />
          </View>
          <Loader loading={loading}>
            <View
              style={{
            ...
            >
              <View style={styles.modal}>
                ...
                >
                  Erreur votre achat de(s){" "}
                  <Text style={{ fontWeight: "bold" }}>{coinsNumber}</Text>
                  piece(s) n'as pas pue etre faite !
                </Text>
              </View>
            </View>
          </Loader>
